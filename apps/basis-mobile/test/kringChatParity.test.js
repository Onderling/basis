...
// Kring-chat receive/fan parity fitness — pins two fixes so the drift cannot recur:
//
// 1. ONE inbox. The kring-chat inbox is the App.js singleton (validation, dedup, ingest mirror,
...
describe('kring chat — one inbox, media-fan parity (web ≡ mobile)', () => {
