...
(`main.js`) + mobile (`CircleLauncherScreen`). Tests: app-manifest renderGate 11; basis
circleGate 9; full suites green (app-manifest 261 · household 588 · basis 2271); web build ✓.
