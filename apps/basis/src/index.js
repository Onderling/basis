...
export { scopeStoopCallSkill, keepForCircle, SCOPED_WRITE_OPS, SCOPED_LIST_OPS, isNoticeboardPost, noticeboardIntentOf, NOTICEBOARD_INTENTS, SYSTEM_STOOP_TYPES } from './v2/circleStoopScope.js';
...
export { bindCircleAddressKeys, forgetCircleAddressKeys, circleSigningKeyOf, hasProvenCircleAddress, circleAddressSetOf }
...
export {
  ...
  personaPresetKeys, revealPresetLabelKey, PERSONA_TIER_KEYS, REVEAL_PRESETS,
} from './v2/memberCards.js';
...
export { EventLog, createEventLog, RETENTION_MS, RETENTION_DEFAULTS, makeAgentTrailEntry } from './eventLog.js';
export {
...
export { sharedCircleLocale, sharedConsequenceLocale, sharedRoleLocale, sharedHostLocale, sharedLocale, mergeShared } from './locales/index.js';
