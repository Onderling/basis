...
// Form-elicitation parity — when a circle command needs a missing field (needsForm with one missing
// param), the bot asks for it IN THE CIRCLE and the user's NEXT message answers (shared src/v2/followUp.js,
